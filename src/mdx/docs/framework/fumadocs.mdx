---
title: FumaDocs Quickstart
description: How to use fumadocs quickly
icon: HousePlus
---
...
<Cards>
  <Card icon={<Cpu className="text-purple-300" />} title="Fumadocs Core">
  ...
  <Card icon={<DatabaseZap />} title="Content Source">
    The source of your content, can be a CMS or local data layers like [Fumadocs MDX](/docs/clerk-quick-start) (the official content source).
  </Card>

  <Card icon={<SquareTerminal />} title="Fumadocs CLI">
...
<Callout title="Want to learn more?">
  Read our in-depth [What is Fumadocs](/docs/clerk-setup) introduction.
</Callout>
...
<Callout title="From Existing Codebase?">
  You can follow the [Manual Installation](/docs/clerk-setup) guide to get started.
</Callout>
...
* `lib/source.ts`: Code for content source adapter, [`loader()`](/docs/clerk-setup) provides the interface to access your content.
