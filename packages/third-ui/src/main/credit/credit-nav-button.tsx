  ...
  return (
    <CreditNavPopoverContext.Provider value={contextValue}>
      ...
      {pricingModal.modalMoneyPriceData && pricingModal.pricingContext ? (
        ...
        >
          <AlertDialogContent className="mt-10 lg:mt-25 w-[95vw] max-w-[1200px] overflow-hidden border border-slate-200 bg-white p-0 shadow-[0_32px_90px_rgba(15,23,42,0.25)] ring-1 ring-black/5 dark:border-white/12 dark:bg-[#0f1222] dark:shadow-[0_40px_120px_rgba(0,0,0,0.6)] dark:ring-white/10">
